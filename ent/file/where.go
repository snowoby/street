...
func SIDContains(v schema.ID) predicate.File {
	vc := string(v)
	return predicate.File(func(s *sql.Selector) {
...
func SIDHasPrefix(v schema.ID) predicate.File {
	vc := string(v)
	return predicate.File(func(s *sql.Selector) {
...
func SIDHasSuffix(v schema.ID) predicate.File {
	vc := string(v)
	return predicate.File(func(s *sql.Selector) {
...
func SIDEqualFold(v schema.ID) predicate.File {
	vc := string(v)
	return predicate.File(func(s *sql.Selector) {
...
func SIDContainsFold(v schema.ID) predicate.File {
	vc := string(v)
	return predicate.File(func(s *sql.Selector) {
