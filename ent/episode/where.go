...
func SIDContains(v schema.ID) predicate.Episode {
	vc := string(v)
	return predicate.Episode(func(s *sql.Selector) {
...
func SIDHasPrefix(v schema.ID) predicate.Episode {
	vc := string(v)
	return predicate.Episode(func(s *sql.Selector) {
...
func SIDHasSuffix(v schema.ID) predicate.Episode {
	vc := string(v)
	return predicate.Episode(func(s *sql.Selector) {
...
func SIDIsNil() predicate.Episode {
	return predicate.Episode(func(s *sql.Selector) {
...
func SIDNotNil() predicate.Episode {
	return predicate.Episode(func(s *sql.Selector) {
...
func SIDEqualFold(v schema.ID) predicate.Episode {
	vc := string(v)
	return predicate.Episode(func(s *sql.Selector) {
...
func SIDContainsFold(v schema.ID) predicate.Episode {
	vc := string(v)
	return predicate.Episode(func(s *sql.Selector) {
